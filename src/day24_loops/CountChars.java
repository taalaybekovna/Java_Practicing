...
public class CountChars {
    ...
    public static void main(String[] args) {
        ...
        String word = "ksjdJSlkmsPKP464ACdv24";
        int upper = 0;
        int lower = 0;
        int number = 0;

        for (int i = 0; i < word.length(); i++) {
            char letter = word.charAt(i); // get the character at the index number i for this iteration, and stores into the variable letter for re-usability
